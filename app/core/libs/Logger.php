...
class Logger
{
    ...
    static function truncate($path = null){
		if ($path === null){
	...
	*/
	...
	static function log($data, ?string $path = null, $append = true){	
		...
		if (is_array($data) || is_object($data))
			$data = json_encode($data, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_PRESERVE_ZERO_FRACTION | JSON_INVALID_UTF8_SUBSTITUTE | JSON_PARTIAL_OUTPUT_ON_ERROR);
